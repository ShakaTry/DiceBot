...
class ParameterValidator:
    ...
    @staticmethod
    def validate_strategy_config(config: dict[str, Any], capital: Decimal) -> dict[str, Any]:
        """
        ...
        try:
            ...
            if capital_ratio > 0.1:  # Plus de 10% du capital
                ...
                warnings["base_bet"] = (
                    f"base_bet is {capital_ratio:.1%} of capital - very risky. "
            ...
            if strategy_name == "martingale" and max_losses > 0:
                ...
                if max_possible_bet > capital:
                    ...
                    warnings["martingale"] = (
                        f"Martingale would require {max_possible_bet:.6f} LTC "
                        f"but capital is only {capital:.6f} LTC. "
                        f"Consider max_losses <= {safe_losses}"
                    )
