...
class TestBaseStrategy:
    ...
    def test_bet_limits_respected(self):
        ...
        bet = strategy._apply_limits(Decimal("20"), Decimal("100"))
        assert bet == Decimal("10")

        # Test avec limite min
        bet = strategy._apply_limits(Decimal("0.01"), Decimal("100"))
    ...
    def test_insufficient_balance(self):
        ...
        game_state = GameState(balance=Decimal("0.5"))
    ...
    def test_bet_below_minimum_after_limits(self):
        ...
        game_state = GameState(balance=Decimal("3"))
        decision = strategy.decide_bet(game_state)
